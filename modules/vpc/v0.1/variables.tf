variable "config_name" {
  ...
  type        = string
  default     = "develop.yaml"
}

variable "enable_flow_logs" {
  description = "Controls if enable vpc flow logs"
  type        = bool
  default     = true
}
...
variable "igw_prefix" {
  description = "Name perfix for internet gateway"
  type        = string
  default     = "igw"
}
...
variable "protected_subnets" {
  description = "A list of protected subnets"
  type        = list(string)
  default     = []
}

variable "create_protected_subnet_route_table" {
  description = "Controls if separate route table for protected should be created"
  type        = bool
  default     = false
}

variable "create_protected_subnet_group" {
  description = "Controls if protected subnet group should be created (n.b. protected_subnets must also be set)"
  type        = bool
  default     = true
}
...
variable "enable_nat_route" {
  description = "Should be true if you want to provision route to NAT Gateway across all of your private networks"
  type        = bool
  default     = true
}
...
variable "protected_inbound_acl_rules" {
  description = "protected subnets inbound network ACL rules"
  type        = list(map(string))
...
variable "protected_outbound_acl_rules" {
  description = "protected subnets outbound network ACL rules"
  type        = list(map(string))
